...
Test(my_env, print_env, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
...
Test(my_cd, return_to_home_nothing, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
    ...
    infos->options[0] = my_strdup("cd");
    cr_assert_not_null(infos->options[0]);
    my_cd(infos);
    system("pwd");
    cr_assert_stdout_eq_str("/home/corentin\n");
}

Test(my_cd, return_to_home_tild, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
    ...
    infos->options[0] = my_strdup("cd");
    cr_assert_not_null(infos->options[0]);
    infos->options[1] = my_strdup("~");
    cr_assert_not_null(infos->options[1]);
    my_cd(infos);
    system("pwd");
    cr_assert_stdout_eq_str("/home/corentin\n");
}

Test(my_cd, go_to_sub_directory_src, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
    ...
    infos->options[0] = my_strdup("cd");
    cr_assert_not_null(infos->options[0]);
    infos->options[1] = my_strdup("src");
    cr_assert_not_null(infos->options[1]);
    my_cd(infos);
    system("pwd");
    cr_assert_stdout_eq_str("/home/corentin/Epitech_projects/2024-2025_tek1/Semester2/PSU/minishell2/B-PSU-200-MLH-2-1-minishell2-corentin.pasquier/src\n");
}

Test(my_cd, go_to_parent_of_parent_directory, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
    ...
    my_cd(infos);
    system("pwd");
    cr_assert_stdout_eq_str("/home/corentin/Epitech_projects/2024-2025_tek1/Semester2/PSU\n");
}

// Exec builtin ///////////////////////////////////////////

Test(exec_builtin, exit_builtin_command, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
    ...
    cr_assert(verification == -255);
    cr_assert_stdout_eq_str("exit\n");
}

Test(exec_builtin, cd_builtin_command_go_to_parent_directory, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
    ...
    cr_assert_not_null(infos->options[1]);
    verification = exec_builtin(infos, &return_value);
    cr_assert(verification == 0);
    cr_assert(return_value == 0);
    system("pwd");
    cr_assert_stdout_eq_str("/home/corentin/Epitech_projects/2024-2025_tek1/Semester2/PSU/minishell2\n");
}

Test(exec_builtin, env_builtin_command, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
    ...
    infos = copy_env(env, ac);
    cr_assert_not_null(infos);
    infos->command = my_strdup("env");
    cr_assert_not_null(infos->command);
    infos->options = malloc(sizeof(char *) * 3);
    cr_assert_not_null(infos->options);
    infos->options[0] = my_strdup("env");
    cr_assert_not_null(infos->options[0]);
    verification = exec_builtin(infos, &return_value);
    cr_assert(verification == 0);
    cr_assert(return_value == 0);
...
Test(exec_builtin, not_builtin_command, .init = redirect)
{
    int ac = 1;
    char **env = create_env();
    command_t *infos;
    ...
    infos->options = malloc(sizeof(char *) * 3);
    cr_assert_not_null(infos->options);
    infos->options[0] = my_strdup("pwd");
    cr_assert_not_null(infos->options[0]);
    verification = exec_builtin(infos, &return_value);
    cr_assert(verification == -1);
    cr_assert(return_value == 0);
}
